...
const startPalette1: THREE.Color[] = map([
    "#E2D0E6", "#E2D0E6", "#E2D0E6", "#E2D0E6", "#E2D0E6",
    "#E3D4E8", "#E3D4E8", "#E3D4E8", "#E0D4EA", "#E5D4E9",
    "#E4D5E9", "#E6D5EA", "#E6D5EA", "#E6D5EA", "#E6D5EA",
    "#E8D6DF", "#E8D6E0", "#E8D6DF", "#E8D6DF", "#E8D6E0",
    "#EED8D0", "#F0D5CE", "#EED9D1", "#EED9D1", "#EED9D1",
    "#F5CCD1", "#FBC8C5", "#F6D0C3", "#F6D3C3", "#F5D4C0",
    "#F8CACD", "#FCC9BD", "#F9C6B5", "#FAC7B7", "#F8D0BD",
    "#FDC8B7", "#F8C4BA", "#F1C6BF", "#F5C5BC", "#F7C5B9",
    "#FAC4C0", "#F9C1C1", "#EBC5CB", "#ECC7C6", "#EFC4C7",
], (hex: string) => new THREE.Color(hex))
